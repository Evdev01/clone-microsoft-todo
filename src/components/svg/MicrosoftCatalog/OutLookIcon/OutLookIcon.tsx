            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <g id="OutLookIcon">
                    <g id="_24" data-name="24">
                        ...
                        <path className="cls-2" d="M21,1H8A1,1,0,0,0,7,2V3l8,2.45L22,3V2A1,1,0,0,0,21,1Z"/>
                        ...
                        <polygon className="cls-4" points="15 3 7 3 7 10 15 18 22 18 22 10 15 3"/>
                        <polyline className="cls-5" points="23.56 22.82 5.29 12.37 5.28 12.37"/>
                        <rect className="cls-6" x="15" y="3" width="7" height="7"/>
                        <rect className="cls-7" x="7" y="10" width="8" height="10"/>
                        <path className="cls-8"
                              d="M14.5,19.5,5.29,12.35l.49-.86,8.61,4.94a.34.34,0,0,0,.24,0l8.5-4.85.5.87Z"/>
                        <polygon className="cls-9" points="13.85 17.27 13.88 17.28 13.85 17.27 13.85 17.27"/>
                        ...
                        <rect id="Back_Plate" data-name="Back Plate" className="cls-7" y="5" width="14" height="14"
                              rx="1.17"/>
